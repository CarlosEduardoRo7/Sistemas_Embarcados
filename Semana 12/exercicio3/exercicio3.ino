...
void loop() {
  ...
  if (estado == 1) {
    ...
    digitalWrite(pin_led3, HIGH); // caso o botão for precionado, pin_led3 será ativado
    digitalWrite(pin_led2, LOW); // caso o botão não for precionado, pin_led2 será desativado
    digitalWrite(pin_led4, LOW); // caso o botão não for precionado, pin_led4 será desativado
  } else {
    digitalWrite(pin_led1, LOW); // caso o botão não for precionado, pin_led1 será desativado
    digitalWrite(pin_led3, LOW); // caso o botão não for precionado, pin_led3 será desativado
    digitalWrite(pin_led2, HIGH); // // caso o botão for precionado, pin_led2 será ativado
    digitalWrite(pin_led4, HIGH); // // caso o botão for precionado, pin_led4 será ativado
  }
